...
def extract_commands(data, frame2, frame1):
    ...
    # frame1 = cv2.imread("inputs/frame_619.jpg")
    # frame2 = cv2.imread("inputs/frame_622.jpg")

    # camera_matrix, dist_coeffs = initialize_camera_parameters()

    # commands = get_best_movement_command(frame1, frame2, camera_matrix, dist_coeffs)
    # print(commands)
